...
// src/pages/admin/BookingManagement/components/AdminBookingFilterSidebar.tsx
...
interface AdminBookingFilterSidebarProps {
  open: boolean;
  onClose: () => void;
...
export const AdminBookingFilterSidebar: React.FC<
  AdminBookingFilterSidebarProps
      ...
      <Box sx={{ width: 350, p: 3 }}>
        ...
        <Stack spacing={3}>
          ...
          <TextField
            ...
            onChange={(e) =>
              handleChange("bookingCode", e.target.value || undefined)
            }
            sx={textFieldSx}
          />
          ...
          <Box>
            ...
            <Stack spacing={2}>
              <TextField
                ...
                onChange={(e) =>
                  handleChange("checkOutDateFrom", e.target.value || undefined)
                }
                sx={textFieldSx}
              />
              <TextField
                ...
                onChange={(e) =>
                  handleChange("checkOutDateTo", e.target.value || undefined)
                }
                sx={textFieldSx}
              />
            </Stack>
