// src/pages/admin/BookingManagement/components/RejectBookingDialog.tsx
// New dialog for reject action
...
export const RejectBookingDialog: React.FC<RejectBookingDialogProps> = ({
  open,
  booking,
  onConfirm,
  onCancel,
  ...
  return (
    <Dialog open={open} onClose={handleClose} maxWidth="sm" fullWidth>
      <DialogTitle>Reject Booking (Admin)</DialogTitle>
      <DialogContent>
        {booking && (
          <Box sx={{ mb: 2 }}>
