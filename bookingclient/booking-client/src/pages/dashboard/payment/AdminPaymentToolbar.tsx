// src/pages/admin/PaymentManagement/components/AdminPaymentToolbar.tsx
...
interface AdminPaymentToolbarProps {
  searchTerm: string;
...
export const AdminPaymentToolbar: React.FC<AdminPaymentToolbarProps> = ({
  searchTerm,
  onSearchChange,
  onRefresh,
  onExportExcel,
  ...
  return (
    ...
    >
      {/* Search */}
      <SearchBox
        placeholder="Tìm kiếm mã thanh toán, khách hàng..."
        value={searchValue}
