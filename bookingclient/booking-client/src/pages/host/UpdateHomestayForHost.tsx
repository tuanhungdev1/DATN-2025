      ...
      <Grid container spacing={3}>
        ...
        >
          <Card
            ...
            onClick={() => navigate(`/host/homestays/${homestayId}/images`)}
          >
            <CardContent>
        ...
        >
          <Card
            ...
            onClick={() => navigate(`/host/homestays/${homestayId}/amenities`)}
          >
            <CardContent>
              <Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>
        ...
        >
          <Card
            ...
            onClick={() => navigate(`/host/homestays/${homestayId}/rules`)}
          >
            <CardContent>
              <Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>
                <RuleIcon color="warning" sx={{ fontSize: 40, mr: 2 }} />
                <Box sx={{ flex: 1 }}>
                  <Typography variant="h6" fontWeight={600}>
                    Quy tắc
                  </Typography>
        ...
        >
          <Card
            ...
            onClick={() =>
              navigate(`/host/homestays/${homestayId}/availability-calendar`)
            }
          >
            <CardContent>
              <Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>
                <CalendarMonthIcon color="info" sx={{ fontSize: 40, mr: 2 }} />
                <Box sx={{ flex: 1 }}>
                  <Typography variant="h6" fontWeight={600}>
                    Lịch khả dụng
                  </Typography>
...
export default UpdateHomestayForHost;
