...
interface HostBookingFilterSidebarProps {
  open: boolean;
  onClose: () => void;
...
export const HostBookingFilterSidebar: React.FC<
  HostBookingFilterSidebarProps
    ...
    <Drawer anchor="right" open={open} onClose={onClose}>
      <Box sx={{ width: 350, p: 3 }}>
        ...
        <Stack spacing={3}>
          ...
          {/* Homestay ID - Host có thể có nhiều homestay */}
          <TextField
            fullWidth
            type="number"
            label="Homestay ID"
