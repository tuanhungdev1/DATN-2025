// src/pages/host/PaymentManagement/HostPaymentDetailPage.tsx
...
const HostPaymentDetailPage: React.FC = () => {
  ...
  // Host Actions (limited - only refund)
  ...
  // Action availability - HOST can only refund completed payments
          ...
          <Grid size={{ xs: 12, lg: 7 }}>
            ...
            <Card elevation={0} sx={cardSx}>
              <CardContent sx={{ p: 3 }}>
                ...
                {/* Action Buttons - HOST only has refund action */}
                {canRefund && (
                ...
                {/* Info message for non-completed payments */}
                {!canRefund && (
                  <Alert severity="info" sx={{ borderRadius: "8px" }}>
                    <Typography variant="body2">
                      {status === PaymentStatus.Pending ||
                      status === PaymentStatus.Processing
                        ? "Giao dịch đang được xử lý. Bạn chỉ có thể hoàn tiền sau khi giao dịch hoàn tất."
                        : status === PaymentStatus.Failed
                        ? "Giao dịch đã thất bại. Không thể hoàn tiền."
                        : "Giao dịch này không thể hoàn tiền."}
                    </Typography>
                  </Alert>
                )}
                  ...
                  <Stack spacing={2}>
                    ...
                    >
                      ...
                      <Typography
                        ...
                        sx={{ cursor: "pointer" }}
                        onClick={() =>
                          navigate(`/host/bookings/${payment.bookingId}`)
                        }
                      >
...
export default HostPaymentDetailPage;
