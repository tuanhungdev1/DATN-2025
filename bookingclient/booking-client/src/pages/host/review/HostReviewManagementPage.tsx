...
import { useReviewManagement } from "@/pages/dashboard/reviews/useReviewManagement";
import { useReviewActions } from "@/pages/dashboard/reviews/useReviewActions";
import { AdminReviewToolbar } from "@/pages/dashboard/reviews/AdminReviewToolbar";
import { DeleteReviewDialog } from "@/pages/dashboard/reviews/DeleteReviewDialog";
import { AdminReviewFilterSidebar } from "@/pages/dashboard/reviews/AdminReviewFilterSidebar";
import { AdminReviewDetailDialog } from "@/pages/dashboard/reviews/AdminReviewDetailDialog";

const HostReviewManagementPage: React.FC = () => {
  ...
  const handleUpdateHostResponse = useCallback(
    ...
    [updateHostResponse, toast, refetch, handleCloseDetailDialog]
  );
...
export default HostReviewManagementPage;
